...
public static class Noise
{
    ...
    public static float AccessNoiseMapWithFloats(float[,] noiseMap, float x, float y)
    {
        float a = Mathf.Lerp(noiseMap[(int)x, (int)y + 1], noiseMap[(int)x + 1, (int)y + 1], x % 1);
        float b = Mathf.Lerp(noiseMap[(int)x, (int)y + 1], noiseMap[(int)x + 1, (int)y + 1], x % 1);
        return Mathf.Lerp(a, b, y % 1);
    }
}
